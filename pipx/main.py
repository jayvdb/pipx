...
def run_pipx_command(args):  # noqa: C901
    ...
    if args.command == "run":
        ...
        commands.uninstall(venv_dir, package, constants.LOCAL_BIN_DIR, verbose)
    elif args.command == "uninstall-all":
        commands.uninstall_all(venv_container, constants.LOCAL_BIN_DIR, verbose)
        ...
        try:
            commands.ensurepath(constants.LOCAL_BIN_DIR, force=args.force)
